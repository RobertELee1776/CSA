...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid confederatestatesofamerica address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid confederatestatesofamerica address" in e.error['message'])
