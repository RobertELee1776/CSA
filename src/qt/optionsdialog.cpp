    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CSA-light"), QVariant("light"));
    ui->theme->addItem(QString("CSA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CSA-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("CSA-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("CSA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CSA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CSA-traditional"), QVariant("trad"));
