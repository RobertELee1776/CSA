...
2. run confederatestatesofamericad with -printalert or -sendalert like this:
   /path/to/confederatestatesofamericad -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.confederatestatesofamerica.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Confederatestatesofamerica Core:0.12.0.58/"));
