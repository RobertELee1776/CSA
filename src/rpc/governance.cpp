...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in confederatestatesofamerica.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("confederatestatesofamerica.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "confederatestatesofamerica",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "confederatestatesofamerica",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "confederatestatesofamerica",               "gobject",                &gobject,                true,  {} },
    { "confederatestatesofamerica",               "voteraw",                &voteraw,                true,  {} },
