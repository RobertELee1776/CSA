...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Confederatestatesofamerica address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "confederatestatesofamerica",               "masternode",             &masternode,             true,  {} },
    { "confederatestatesofamerica",               "masternodelist",         &masternodelist,         true,  {} },
    { "confederatestatesofamerica",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "confederatestatesofamerica",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "confederatestatesofamerica",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "confederatestatesofamerica",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
