...
*Setup instructions for a Gitian build of Confederatestatesofamerica Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Confederatestatesofamerica
...
to confederatestatesofamerica.org.
...
- [Building Confederatestatesofamerica Core](#building-confederatestatesofamerica-core)
...
Clone the git repositories for Confederatestatesofamerica Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/confederatestatesofamericapay/confederatestatesofamerica
...
in the Confederatestatesofamerica Core repository under 'Fetch and create inputs' to install sources which require
manual intervention. Also optionally follow the next step: 'Seed the Gitian sources cache
and offline git repositories' which will fetch the remaining files required for building
offline.

Building Confederatestatesofamerica Core
----------------

To build Confederatestatesofamerica Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Confederatestatesofamerica Core repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/confederatestatesofamerica/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/confederatestatesofamericapay/confederatestatesofamerica
...
For example:
```bash
URL=https://github.com/crowning-/confederatestatesofamerica.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit confederatestatesofamerica=${COMMIT} --url confederatestatesofamerica=${URL} ../confederatestatesofamerica/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit confederatestatesofamerica=${COMMIT} --url confederatestatesofamerica=${URL} ../confederatestatesofamerica/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit confederatestatesofamerica=${COMMIT} --url confederatestatesofamerica=${URL} ../confederatestatesofamerica/contrib/gitian-descriptors/gitian-osx.yml
```
...
and the confederatestatesofamerica git repository with the desired tag must both be available locally, and then gbuild must be
...
LXC_ARCH=amd64 LXC_SUITE=trusty on-target -u root \
  ...
  $( sed -ne '/^packages:/,/[^-] .*/ {/^- .*/{s/"//g;s/- //;p}}' ../confederatestatesofamerica/contrib/gitian-descriptors/*|sort|uniq )
...
BTCPATH=/some/root/path/confederatestatesofamerica
SIGPATH=/some/root/path/confederatestatesofamerica-detached-sigs

./bin/gbuild --url confederatestatesofamerica=${BTCPATH},signature=${SIGPATH} ../confederatestatesofamerica/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/confederatestatesofamerica-linux-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/confederatestatesofamerica-win-build.assert
    gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/confederatestatesofamerica-osx-build.assert
```
...
[confederatestatesofamerica/gitian.sigs](https://github.com/confederatestatesofamericapay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
