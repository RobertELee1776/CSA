...
This document provides guidelines for internationalization of the Confederatestatesofamerica Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `confederatestatesofamerica_en.ts` remains unchanged.
