...
This mechanism has been integrated into Bitcore-Node-Confederatestatesofamerica which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/confederatestatesofamericapay/insight-api-confederatestatesofamerica#web-socket-api](https://github.com/confederatestatesofamericapay/insight-api-confederatestatesofamerica#web-socket-api)
* API: [https://github.com/confederatestatesofamericapay/insight-api-confederatestatesofamerica#instantsend-transactions](https://github.com/confederatestatesofamericapay/insight-api-confederatestatesofamerica#instantsend-transactions)
...
By default, the Confederatestatesofamerica Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Confederatestatesofamerica Core daemon:
